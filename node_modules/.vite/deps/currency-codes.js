...
var require_first_match = __commonJS({
  "node_modules/first-match/index.js"(exports, module) {
    function truthy(d) {
      return d;
    }
    function first(array, callback, context) {
      var callback = callback || truthy, context = context || array, value;
      for (var i = 0, l = array.length; i < l; i += 1) {
        if (value = callback.call(context, array[i], i))
          return array[i];
      }
    }
...
var require_nub = __commonJS({
  "node_modules/nub/index.js"(exports, module) {
    var nub = module.exports = function(xs, cmp) {
      ...
      for (var i = 0; i < xs.length; i++) {
        var x = xs[i];
        var recs = x === "__proto__" ? keys.objects : keys[typeof x] || keys.objects;
...
var require_data = __commonJS({
  "node_modules/currency-codes/data.js"(exports, module) {
    module.exports = [
      {
        "code": "AED",
        "number": "784",
...
var require_iso_4217_publish_date = __commonJS({
  "node_modules/currency-codes/iso-4217-publish-date.js"(exports, module) {
    module.exports = "2024-06-25";
  }
});

// node_modules/currency-codes/index.js
var require_currency_codes = __commonJS({
  "node_modules/currency-codes/index.js"(exports) {
    var first = require_first_match();
    var nub = require_nub();
    var data = require_data();
    var publishDate = require_iso_4217_publish_date();
    var code = function(code2) {
      code2 = code2.toUpperCase();
      return first(data, function(c) {
        return c.code === code2;
      });
    };
    var country = function(country2) {
      country2 = country2.toLowerCase();
      return data.filter(function(c) {
        return (c.countries.map(function(c2) {
    ...
    var number = function(number2) {
      return first(data, function(c) {
        return c.number === String(number2);
      });
    };
    var codes = function() {
...
export default require_currency_codes();
